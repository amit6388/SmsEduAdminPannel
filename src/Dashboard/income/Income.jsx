...
const Income = () => {
  ...
  return (
    <div className=" p-5 shadow-lg scrollbar-hide bg-[#f5f6fa]">
      ...
      <AddIncome open={open} handleOpen={handleOpen} />
            ...
            <tbody>
              ...
              <tr class="bg-white border-b">
                ...
                <td class="px-6 py-4 max-w-xs">
                  the worker should wear disposable rubber boots, gloves (heavy
                  duty), and a triple layer mask.
                </td>

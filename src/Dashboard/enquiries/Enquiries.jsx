...
const Enquiries = () => {
  ...
  return (
    <div>
      <div className="max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-none mx-auto px-3 sm:px-5 py-5 ml-auto shadow-lg  h-[100vh] overflow-y-scroll scrollbar-hide bg-[#f5f6fa]">

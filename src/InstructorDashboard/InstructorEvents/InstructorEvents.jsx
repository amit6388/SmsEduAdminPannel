  ...
  return (
    <>
      <div className="p-5 ml-auto shadow-lg  h-[100vh] overflow-y-scroll scrollbar-hide bg-[#f5f6fa] mt-5">
        ...
        <ModalAddEvent open={open} handleOpen={handleOpen} />
              ...
              <tbody>
                ...
                <tr class="bg-white border-b">
                  ...
                  <td class="px-6 py-4 hidden sm:table-cell max-w-xs">
                    ...
                    Ullam nihil quae, adipisci maiores aut quisquam nesciunt?
                    Rem obcaecati nihil error.
                  </td>
                  <td class="px-6 py-4 hidden sm:table-cell">08/08/2023</td>
                  <td class="px-6 py-4 hidden md:table-cell">09/08/2023</td>
                  <td class="px-1 py-4">
                    <div>
                      <Menu>
                        <MenuHandler>
                      ...
                      <ModalEditEvent open={open2} handleOpen={handleOpen2} />
                    </div>
                  </td>
                </tr>
                {/* {pageData.map((item) => {
                  if (
                    ...
                    return (
                      <>
                        <ScheduleClassesTable item={item} />
                      </>
                    );
                  }
                })} */}

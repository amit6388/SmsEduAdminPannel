  ...
  return (
    <>
      <tr class="bg-white border-b" key={item._id}>
        ...
        <td class="px-6 py-4 hidden md:table-cell">{item.course}</td>
        <td class="px-3 py-4 hidden lg:table-cell">{item.total_marks}</td>
        <td class="px-3 py-4 hidden lg:table-cell">{item.obtain_marks}</td>
        <td class="px-1 py-4">
          <div>
            <Menu>
              <MenuHandler>
